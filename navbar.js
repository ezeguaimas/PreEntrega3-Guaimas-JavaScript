...
navbarImagen.addEventListener('animationend', () => navbarImagen.classList.remove('animate__hinge'));
navbarImagen.addEventListener('animationend', () => navbarImagen.classList.add('animate__bounceInUp'));
navbarImagen.addEventListener('onmouseout', () => navbarImagen.classList.remove('animate__bounceInUp'));
